#tolls_roads {
	...
	// Sometimes there are smaller roads (even forest tracks) that are tagged with toll=yes. We show those only at the zoom levels
	// where openstreetmap-carto starts showing them.
